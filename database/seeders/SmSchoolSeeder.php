...
class SmSchoolSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 1, 'value'   => "#008fd4"];
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 2, 'value'  => "#008fd4"];
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 3, 'value'  => "#1bc1e5"];
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 4, 'value'  => "#008fd4"];
        ...
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 11, 'value' => "#1bc1e5"];
        ...
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 16, 'value' => "#008fd4"];
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 17, 'value'  => "#222222"];
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 18, 'value'  => "#008fd4"];
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 19, 'value'  => "transparent"];
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 20, 'value'  => "#4c5c9b"];
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 21, 'value'  => "#008fd4"];
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 29, 'value'  => "#008fd4"];
