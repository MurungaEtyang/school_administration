...
--gradient_3: #008fd4;
    ...
    --primary-color: #008fd4;
    --card-gradient-cyan: linear-gradient(to right, #06b6d4, #22d3ee);
    --card-gradient-violet: linear-gradient(to right, #008fd4, #008fd4);
    --card-gradient-blue: linear-gradient(to right, #3b82f6, #60a5fa);
    --card-gradient-fuchsia: linear-gradient(to right, #008fd4, #008fd4);
    --card-gradient-cyan-hover: linear-gradient(to right, #06b6d4, #22d3ee);
    --card-gradient-violet-hover: linear-gradient(to right, #008fd4, #008fd4);
    --card-gradient-blue-hover: linear-gradient(to right, #3b82f6, #60a5fa);
    --card-gradient-fuchsia-hover: linear-gradient(to right, #008fd4, #008fd4);
...
</style><?php /**PATH /opt/lampp/htdocs/resources/views/backEnd/partials/css.blade.php ENDPATH**/ ?>