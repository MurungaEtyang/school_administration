...
class CreateSmStylesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $s->primary_color = '#008fd4';
        $s->primary_color2 = '#008fd4';
        ...
        $s->barchart1 = '#8a33f8';
        $s->barchart2 = '#f25278';
        $s->barcharttextcolor = '#008fd4';
        $s->barcharttextfamily = '"poppins", sans-serif';
        $s->areachartlinecolor1 = 'rgba(50, 146, 255, 0.5)';
        $s->areachartlinecolor2 = 'rgba(50, 146, 255, 0.5)';
