...
class CreateColorsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $sql = [
            ...
            ['name'  => "gradient_2", 'default_value' => "#1bc1e5" , 'lawn_green' =>'#03e396', 'is_color'=>1, 'status'=>1],
            ...
            ['name'  => "border_color", 'default_value' => "#1bc1e5" , 'lawn_green' =>'#03e396', 'is_color'=>1, 'status'=>1],
            ...
            ['name'  => "title_color", 'default_value' => '#008fd4' , 'lawn_green' =>'#008fd4', 'is_color'=>1, 'status'=>1],
            ...
            ['name'  => "sidebar_hover", 'default_value' => '#008fd4' , 'lawn_green' =>'#e7ecff', 'is_color'=>1, 'status'=>1],
