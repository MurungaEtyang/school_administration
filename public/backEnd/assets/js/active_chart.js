...
(function($) {
    ...
    $(function() {
      ...
      if ($("#visit-sale-chart").length) {
        ...
        gradientStrokeViolet.addColorStop(0, 'rgba(50, 146, 255,1)');
        gradientStrokeViolet.addColorStop(1, 'rgba(56, 187, 216,1)');
        var gradientLegendViolet = 'linear-gradient(to right, rgba(50, 146, 255,1), rgba(56, 187, 216,1))';
        
        var gradientStrokeBlue = ctx.createLinearGradient(0, 0, 0, 90);
        gradientStrokeBlue.addColorStop(0, '#1bc1e5');
        gradientStrokeBlue.addColorStop(1, ' #D7598F');
        var gradientLegendBlue = 'linear-gradient(90deg, #1bc1e5 0.47%, #D7598F 100%)';
...
if($('#line_chart').length > 0){
  ...
  xLabels: "month",
  labels: ['Series A'],
  lineColors: ['#008fd4', '#008fd4'],
  hideHover: 'auto',
  pointSize: 0,
  pointFillColors: ['#ffffff'],
  pointStrokeColors:['#008fd4'],
  lineWidth: 3,
  fillOpacity: 0.5,
  smooth:false
  });
