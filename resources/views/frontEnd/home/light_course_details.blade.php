...
@endpush
    ...
    <section class="container box-1420">
        <div class="banner-area" style="background: linear-gradient(0deg, rgba(50, 146, 255, 0.6), rgba(56, 187, 216, 0.6)), url({{$course->image != ""? asset($course->image) : '../img/client/common-banner1.jpg'}}) no-repeat center;">
