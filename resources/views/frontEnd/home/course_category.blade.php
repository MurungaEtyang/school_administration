...
@section('main_content')
    ...
    <section class="container box-1420">
        <div class="banner-area" style="background: linear-gradient(0deg, rgba(50, 146, 255, 0.6), rgba(56, 187, 216, 0.6)), url({{$category_id->category_image != ""? asset($category_id->category_image) : '../img/client/common-banner1.jpg'}}) no-repeat center;">
