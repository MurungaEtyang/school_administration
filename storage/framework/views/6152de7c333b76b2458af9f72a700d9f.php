...
:root {
    <?php
        ...
        $violet_one = '#008fd4';
        $violet_one_hover = '#008fd4';
        $violet_two = '#008fd4';
        $violet_two_hover = '#008fd4';
        $blue_one = '#3b82f6';
        $blue_one_hover = '#3b82f6';
        $blue_two = '#60a5fa';
        $blue_two_hover = '#60a5fa';
        $fuchsia_one = '#008fd4';
        $fuchsia_one_hover = '#008fd4';
        $fuchsia_two = '#008fd4';
        $fuchsia_two_hover = '#008fd4';
    ?>
...
</style><?php /**PATH /opt/lampp/htdocs/resources/views/components/root-css.blade.php ENDPATH**/ ?>